/*|AGS|*/
IF  EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N't_palet_multiestiba_conteo') AND type in (N'U'))
DROP TABLE t_palet_multiestiba_conteo
/*|AGS|*/
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N't_palet_multiestiba_conteo') AND type in (N'U'))
BEGIN
