...
namespace ApiAgrosmart.Controllers
{
    ...
    public class UbicacionesController : ApiController
    {
        ...
        [HttpPut]
        [Route("api/ControlUbicaciones")]
        public string ControlEstiba(string as_empresa, int as_operation, string as_json)
        {
            WebLog.Write(EventLogType.Information, "Iniciando  Operacion =" + as_operation + "[ControlUbicaciones]");
            var sp = "sp_AppControlUbicacion";
            int success = 0;
            string message = "";
            ...
            using (var sqlCon = new SqlConnection(configuration.Conexion))
            {
                try
                {
                    WebLog.Write(EventLogType.Information, "Abriendo Conexion ala Base de datos[ControlUbicaciones]");
                    sqlCon.Open();
                    ...
                    WebLog.Write(EventLogType.Information, "Ejecutando Procedimiento sp_AppControlUbicacion [ControlUbicaciones]");
